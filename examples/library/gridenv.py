...
small_env_fn = lambda seed: GridWorld(
    small_world, slip=0.2, log=False, max_episode_step=1000, random_state=seed
)
big_env_fn = lambda seed: GridWorld(
    big_world,
    slip=0.2,
    log=False,
...
big_renv_fn = lambda seed: ractGridWorld(
    big_world,
    slip=0.2,
    log=False,
    max_episode_step=2000,
